...
MENU eof_right_click_menu_normal[] =
{
	...
	{"Place fl&Oating event", eof_menu_song_add_floating_text_event_at_mouse, NULL, 0, NULL},
	{"Set &Start point\tALT+Home", eof_menu_edit_set_start_point_at_mouse, NULL, 0, NULL},
	{"Set &End point\tALT+End", eof_menu_edit_set_end_point_at_mouse, NULL, 0, NULL},
	{"Set &Fret hand position", eof_track_pro_guitar_set_fret_hand_position_at_mouse, NULL, 0, NULL},
	{"Place &Tone change", eof_track_rs_tone_change_add_at_mouse, NULL, 0, NULL},
...
void eof_prepare_context_menu(void)
{
	...
	{	//If a chart is loaded
		...
		{	//If the pen note is at a valid position
			...
			eof_right_click_menu_note[8].flags = 0;		//Place floating event
			eof_right_click_menu_normal[11].flags = 0;	//Set fret hand position
			eof_right_click_menu_note[11].flags = 0;	//Set fret hand position
			eof_right_click_menu_normal[12].flags = 0;	//Place tone change
			eof_right_click_menu_note[12].flags = 0;	//Place tone change
		}
		else
		{
			...
			eof_right_click_menu_note[11].flags = D_DISABLED;
