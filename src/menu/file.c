...
MENU eof_file_notes_panel_menu[] =
{
	...
	{"Rock &Band", eof_menu_file_notes_panel_rockband, NULL, 0, NULL},
...
void eof_prepare_file_menu(void)
{
	...
	//Notes panel stuff
	eof_file_notes_panel_menu[11].flags = eof_enable_notes_panel ? D_SELECTED : 0;		//File>Display>Notes Panel>Enable
...
int eof_menu_file_notes_panel_rockband(void)
{
	eof_log("Switching Notes Panel to Rock Band.", 1);
