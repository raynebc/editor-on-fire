...
extern NCDFS_FILTER_LIST * eof_filter_theme_files;
...
extern int eof_color_notes_panel_error_bg_raw, eof_color_notes_panel_error_fg_raw;
extern int eof_color_notes_panel_warning_bg_raw, eof_color_notes_panel_warning_fg_raw;
extern int eof_color_notes_panel_success_bg_raw, eof_color_notes_panel_success_fg_raw;
extern int eof_color_notes_panel_alert_bg_raw, eof_color_notes_panel_alert_fg_raw;
extern int eof_color_notes_panel_info_bg_raw, eof_color_notes_panel_info_fg_raw;
extern int eof_color_notes_panel_error_bg, eof_color_notes_panel_error_fg;
extern int eof_color_notes_panel_warning_bg, eof_color_notes_panel_warning_fg;
extern int eof_color_notes_panel_success_bg, eof_color_notes_panel_success_fg;
extern int eof_color_notes_panel_alert_bg, eof_color_notes_panel_alert_fg;
extern int eof_color_notes_panel_info_bg, eof_color_notes_panel_info_fg;
...
extern int eof_color_tab_notation_bg, eof_color_tab_notation_bg_raw;
extern int eof_color_tab_notation_fg, eof_color_tab_notation_fg_raw;
...
extern char        eof_vocal_tab_name[EOF_MAX_DIFFICULTIES][16];
...
unsigned long eof_get_selected_note_range(unsigned long *sel_start, unsigned long *sel_end, char function);
	...
	//If function is zero, the information returned via the pointers is the index number of the notes, otherwise it is their timestamps (start position of first selected note and end position of last selected note)
...
void eof_determine_phrase_status(EOF_SONG *sp, unsigned long track);
	//Re-applies the HOPO, SP, solo, trill, tremolo, slider and kick drum lane status of each note in the specified track, as well as deleting empty SP, Solo, trill, tremolo, arpeggio, slider and kick drum lane phrases
void eof_cat_track_difficulty_string(char *str, unsigned long buffersize);	//Concatenates the current track name and difficulty name/number to the specified string, which is an array of the specified number of bytes in size
