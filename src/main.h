...
int eof_note_is_gh3_hopo(EOF_SONG *sp, unsigned long track, unsigned long note, double threshold);
	...
	//	Is not explicitly marked as a non HOPO, and isn't a chord, and isn't the same as the previous note, and is less than (threshold) amount of beats from a previous note
