...
int         eof_gp_import_truncate_short_chords = 0;	//If nonzero during GP import, chords shorter than one quarter note are set to the minimum length of 1ms
...
int         eof_dont_restrict_tone_change_timing = 0;	//If nonzero, tone changes aren't prevented from being placed on top of a note
...
int         eof_midi_export_enhanced_open_marker = 0;	//If nonzero, open notes export to MIDI with the use of an "[ENHANCED_OPENS]" text event and a MIDI marker one note below lane 1, and sliders export as MIDI marker 104 instead of using Sysex
