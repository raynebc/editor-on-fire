//This is some minimal code to ensure that the EOF import/export functions I supply compile with 0 warnings/errors

#define TESTCOMPILETHIS
#ifdef TESTCOMPILETHIS
...
//
//NewCreature's original lyric structures and functions
//
/*typedef struct
{
	char note;
...
#define EOF_LYRIC_LINE_FLAG_OVERDRIVE 1
	//This is a bit flag that is used to define a line's overdrive status
...
//
//My import/export functions to interface with EOF
//
