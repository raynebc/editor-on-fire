...
int eof_note_compare(EOF_SONG *sp, unsigned long track1, unsigned long note1, unsigned long track2, unsigned long note2, char thorough);
	...
	//If the thorough parameter is nonzero, the notes' flags, extended flags, accent and ghost bitmasks must also be identical, and the notes must both have sustain or both have no sustain
