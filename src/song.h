...
#define EOF_NOTE_TFLAG_LN        8192	//This flag will indicate that the affected chord has chordify status and should RS2 export with the linknext tag overridden to be enabled
