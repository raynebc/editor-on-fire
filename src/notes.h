...
extern char eof_notes_macro_note_name_maj_conflict[50];			//Stores a string identifying the first culprit of the %IF_ACTIVE_TRACK_RS_ANY_NOTES_NAME_MAJ_CONFLICT% condition
extern char eof_notes_macro_finger_violations[50];				//Stores a string identifying the first culprit of the %IF_ACTIVE_TRACK_RS_ANY_FINGER_VIOLATIONS% condition
extern char eof_notes_macro_finger_violations_reason[60];			//Stores a string identifying the reason the note was implicated by the %IF_ACTIVE_TRACK_RS_ANY_FINGER_VIOLATIONS% condition
