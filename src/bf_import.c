			...
			{	//If the name of the string was identified
				...
				{	//voxpushphrase object
					...
					{	//For each lyric line in this object
						...
						eof_log(eof_log_string, 1);
						(void) eof_vocal_track_add_line(sp->vocal_track[0], startms, endms, 0, 0xFF);	//Add the lyric line
					}
				}
...
//Update path variables
	...
	(void) ustrzcpy(eof_loaded_song_name, sizeof(eof_loaded_song_name), get_filename(fn));
