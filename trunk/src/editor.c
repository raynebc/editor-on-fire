...
{
	if(eof_song->track[eof_selected_track-1]->trackformat == EOF_LEGACY_TRACK_FORMAT)
	{
		if(note < eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->notes)
		{
			eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[note]->length = pos - eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[note]->pos;
		}
	}
}
...
{
	if(note < eof_song->vocal_track[0]->lyrics)
	{
		eof_song->vocal_track[0]->lyric[note]->length = pos - eof_song->vocal_track[0]->lyric[note]->pos;
	}
}
...
void eof_read_editor_keys(void)
{
	...
	else if(key[KEY_UP] && eof_music_paused && !eof_music_catalog_playback)
	{
		...
		if(eof_vocals_selected && eof_mix_vocal_tones_enabled && (eof_selection.current < eof_song->vocal_track[0]->lyrics) && (eof_song->vocal_track[0]->lyric[eof_selection.current]->note != EOF_LYRIC_PERCUSSION))
		{
			eof_mix_play_note(eof_song->vocal_track[0]->lyric[eof_selection.current]->note);
		}
		key[KEY_UP] = 0;
	}
		...
		if(eof_vocals_selected)
		{
			...
			if(eof_snap_mode == EOF_SNAP_OFF)
			{
				if(KEY_EITHER_CTRL)
				{
					for(i = 0; i < eof_song->vocal_track[0]->lyrics; i++)
					{
						...
						{
							eof_song->vocal_track[0]->lyric[i]->length -= 10;
						}
					}
				}
				else
				{
					for(i = 0; i < eof_song->vocal_track[0]->lyrics; i++)
					{
						if((eof_selection.track == EOF_TRACK_VOCALS) && eof_selection.multi[i])
						{
							eof_song->vocal_track[0]->lyric[i]->length -= 100;
						}
					}
				}
			}
			else
			{
				...
				for(i = 0; i < eof_song->vocal_track[0]->lyrics; i++)
				{
					if((eof_selection.track == EOF_TRACK_VOCALS) && eof_selection.multi[i])
					{
						b = eof_get_beat(eof_song, eof_song->vocal_track[0]->lyric[i]->pos + eof_song->vocal_track[0]->lyric[i]->length - 1);
						if(b >= 0)
						{
						...
						{
							eof_snap_logic(&eof_tail_snap, eof_song->vocal_track[0]->lyric[i]->pos + eof_song->vocal_track[0]->lyric[i]->length - 1);
						}
						eof_snap_length_logic(&eof_tail_snap);
						eof_song->vocal_track[0]->lyric[i]->length -= eof_tail_snap.length;
						if(eof_song->vocal_track[0]->lyric[i]->length > 1)
						{
							eof_snap_logic(&eof_tail_snap, eof_song->vocal_track[0]->lyric[i]->pos + eof_song->vocal_track[0]->lyric[i]->length);
		...
		else
		{
			...
			if(eof_snap_mode == EOF_SNAP_OFF)
			{
				if(KEY_EITHER_CTRL)
				{
					for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->notes; i++)
					{
						...
						{
							eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->length -= 10;
						}
					}
				}
				else
				{
					for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->notes; i++)
					{
						if((eof_selection.track == eof_selected_track) && eof_selection.multi[i] && (eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->type == eof_note_type))
						{
							eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->length -= 100;
						}
					}
				}
			}
			else
			{
				...
				for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->notes; i++)
				{
					if((eof_selection.track == eof_selected_track) && eof_selection.multi[i] && (eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->type == eof_note_type))
					{
						b = eof_get_beat(eof_song, eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->pos + eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->length - 1);
						if(b >= 0)
						{
							eof_snap_logic(&eof_tail_snap, eof_song->beat[b]->pos);
						}
						...
						{
							eof_snap_logic(&eof_tail_snap, eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->pos + eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->length - 1);
						}
						eof_snap_length_logic(&eof_tail_snap);
						eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->length -= eof_tail_snap.length;
		...
		if(eof_vocals_selected)
		{
			...
			else
			{
				for(i = 0; i < eof_song->vocal_track[0]->lyrics; i++)
				{
					...
					{
						eof_snap_logic(&eof_tail_snap, eof_song->vocal_track[0]->lyric[i]->pos + eof_song->vocal_track[0]->lyric[i]->length + 1);
						if(eof_tail_snap.pos > eof_song->vocal_track[0]->lyric[i]->pos + eof_song->vocal_track[0]->lyric[i]->length + 1)
						{
							eof_set_tail_pos(i, eof_tail_snap.pos);
						}
						else
		...
		else
		{
			...
			else
			{
				for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->notes; i++)
				{
					...
					{
						eof_snap_logic(&eof_tail_snap, eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->pos + eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->length + 1);
						if(eof_tail_snap.pos > eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->pos + eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->length + 1)
						{
							eof_set_tail_pos(i, eof_tail_snap.pos);
						}
						else
...
//		}
	...
	if(key[KEY_L])
	{
		...
		else if(eof_vocals_selected && (eof_selection.track == EOF_TRACK_VOCALS) && (eof_selection.current < eof_song->vocal_track[0]->lyrics))
		{
			if(KEY_EITHER_SHIFT)
			{	//Split lyric
				...
				else
				{
					...
					if(bitmask)	//If user has pressed any key from 1 through 5
					{
						...
						{	//If the user edited an existing note
							eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[eof_hover_note]->note ^= bitmask;
							...
							if(!eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[eof_hover_note]->note)
							{
								eof_track_delete_note(eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum], eof_hover_note);
							...
							if(eof_selection.current != EOF_MAX_NOTES - 1)
							{
								...
								eof_selection.current_pos = eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[eof_selection.current]->pos;
						...
						{	//If the user created a new note
							...
							if(new_note)
							{
								...
								if(eof_mark_drums_as_cymbal)
								{	//If the user opted to make all new drum notes cymbals automatically
									eof_mark_new_note_as_cymbal(eof_song,eof_selected_track,eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->notes-1);
								}
								...
								memset(eof_selection.multi, 0, sizeof(char) * EOF_MAX_NOTES);
								eof_track_sort_notes(eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]);
								eof_track_fixup_notes(eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum], 0);
								eof_determine_hopos();
								eof_selection.multi[eof_selection.current] = 1;
								eof_detect_difficulties(eof_song);
							}
		...
		if(key[KEY_ENTER] && eof_song_loaded)
		{
			...
			if(eof_music_paused)
			{
				...
				if(new_note)
				{
					...
					eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->type = eof_note_type;
					eof_detect_difficulties(eof_song);
				}
				key[KEY_ENTER] = 0;
			}
...
//					eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[eof_entering_note_note]->length = (eof_music_pos - eof_av_delay) - eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[eof_entering_note_note]->pos;
				}
			}
		}
...
void eof_editor_logic(void)
{
	...
	if(eof_music_paused && eof_song_loaded)
	{
		...
		if((mouse_y >= eof_window_editor->y + 25 + EOF_EDITOR_RENDER_OFFSET) && (mouse_y < eof_window_editor->y + eof_screen_layout.fretboard_h + EOF_EDITOR_RENDER_OFFSET))
		{
			...
			use_this_x = lpos;
			eof_pen_visible = 1;
			for(i = 0; (i < eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->notes) && (eof_hover_note < 0); i++)
			{
				if(eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->type == eof_note_type)
				{
					npos = eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->pos;
			...
			if((eof_input_mode == EOF_INPUT_PIANO_ROLL) || (eof_input_mode == EOF_INPUT_REX))
			{
				if(eof_hover_note >= 0)
				{
					eof_pen_note.note = eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[eof_hover_note]->note;
					eof_pen_note.length = eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[eof_hover_note]->length;
					if(!eof_mouse_drug)
					{
						eof_pen_note.pos = eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[eof_hover_note]->pos;
			...
			if((mouse_b & 1) && eof_lclick_released)
			{
				...
				if(eof_hover_note >= 0)
				{
					...
					else
					{
						...
						eof_selection.last_pos = eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[eof_selection.last]->pos;
					}
					eof_selection.current = eof_hover_note;
					eof_selection.current_pos = eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[eof_selection.current]->pos;
					if(KEY_EITHER_SHIFT)
					...
					eof_peg_x = eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[eof_pegged_note]->pos;
					if(!KEY_EITHER_CTRL)
					{
						...
						if(KEY_EITHER_SHIFT && !ignore_range)
						{
							...
							if(eof_selection.range_pos_1 < eof_selection.range_pos_2)
							{
								for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->notes; i++)
								{
									if((eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->type == eof_note_type) && (eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->pos >= eof_selection.range_pos_1) && (eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->pos <= eof_selection.range_pos_2))
									{
							...
							else
							{
								for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->notes; i++)
								{
									if((eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->type == eof_note_type) && (eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->pos >= eof_selection.range_pos_2) && (eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->pos <= eof_selection.range_pos_1))
									{
										if(eof_selection.track != eof_selected_track)
										{
											eof_selection.track = eof_selected_track;
...
//					eof_mouse_drug = 1;
				...
				if((eof_mouse_drug > 10) && (eof_selection.current != EOF_MAX_NOTES - 1))
				{
					...
					{
						move_offset = eof_pen_note.pos - eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[eof_selection.current]->pos;
					}
					...
					for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->notes; i++)
					{
						if(eof_selection.multi[i])
						{
							if((eof_snap_mode == EOF_SNAP_OFF) || KEY_EITHER_CTRL)
							{
								if(eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->pos == eof_selection.current_pos)
								{
									eof_selection.current_pos += eof_mickeys_x * eof_zoom;
								}
								eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->pos += eof_mickeys_x * eof_zoom;
							}
							else
							{
								if(eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->pos == eof_selection.current_pos)
								...
								eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->pos += move_offset;
							}
							if(eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->pos + eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->length >= eof_music_length)
							{
								revert = 1;
								revert_amount = eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->pos + eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->length - eof_music_length;
							}
						}
					}
					if(revert)
					{
						for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->notes; i++)
						{
							if(eof_selection.multi[i])
							{
								eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->pos -= revert_amount;
							}
						}
					}
				}
//				eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[eof_pegged_note].pos = eof_peg_x + (mouse_x - eof_click_x) * eof_zoom;
			}
			...
			if(eof_snap_mode == EOF_SNAP_OFF)
			{
				if(KEY_EITHER_CTRL)
				{
					for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->notes; i++)
					{
						if((eof_selection.track == eof_selected_track) && eof_selection.multi[i] && (eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->type == eof_note_type))
						{
							eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->length -= eof_mickey_z * 10;
						}
					}
				}
				else
				{
					for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->notes; i++)
					{
						if((eof_selection.track == eof_selected_track) && eof_selection.multi[i] && (eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->type == eof_note_type))
						{
							eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->length -= eof_mickey_z * 100;
						}
					}
				}
			}
				...
				if(eof_mickey_z > 0)
				{
					for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->notes; i++)
					{
						if((eof_selection.track == eof_selected_track) && eof_selection.multi[i] && (eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->type == eof_note_type))
						{
							...
							eof_snap_length_logic(&eof_tail_snap);
//							allegro_message("%d, %d\n%lu, %lu", eof_tail_snap.length, eof_tail_snap.beat, eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->pos + eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->length, eof_song->beat[eof_tail_snap.beat]->pos);
							eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->length -= eof_tail_snap.length;
							if(eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->length > 1)
							{
								eof_snap_logic(&eof_tail_snap, eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->pos + eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->length);
...
//				eof_selected_beat = eof_hover_beat;
	...
	else if(eof_song_loaded)
	{
		...
		for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->notes; i++)
		{
			if(eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->type == eof_note_type)
			{
				npos = eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->pos / eof_zoom;
				if((pos - eof_av_delay / eof_zoom > npos) && (pos - eof_av_delay / eof_zoom < npos + (eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->length > 100 ? eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->length : 100) / eof_zoom))
				{
					eof_hover_note = i;
					break;
				}
		...
		if(i == eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->notes)
		{
			eof_hover_note = -1;
		}
		for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->notes; i++)
		{
			...
			{
				npos = eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->pos;
				if((eof_music_pos > npos) && (eof_music_pos < npos + (eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->length > 100 ? eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->length : 100)))
				{
...
void eof_vocal_editor_logic(void)
{
	...
	if(eof_music_paused && eof_song_loaded)
	{
		...
		else if((mouse_y >= eof_window_editor->y + 25 + EOF_EDITOR_RENDER_OFFSET) && (mouse_y < eof_window_editor->y + eof_screen_layout.fretboard_h + EOF_EDITOR_RENDER_OFFSET))
		{
			...
			use_this_x = lpos;
			eof_pen_visible = 1;
			for(i = 0; (i < eof_song->vocal_track[0]->lyrics) && (eof_hover_note < 0); i++)
			{
				npos = eof_song->vocal_track[0]->lyric[i]->pos;
				if((use_this_x > npos) && (use_this_x < npos + eof_song->vocal_track[0]->lyric[i]->length))
				{
					eof_hover_note = i;
				}
			...
			{
				eof_pen_lyric.pos = eof_song->vocal_track[0]->lyric[eof_hover_note]->pos;
				eof_pen_lyric.length = eof_song->vocal_track[0]->lyric[eof_hover_note]->length;
			}
			if((eof_input_mode == EOF_INPUT_PIANO_ROLL) || (eof_input_mode == EOF_INPUT_REX))
			{
				if(eof_hover_note >= 0)
			...
			if((mouse_b & 1) && eof_lclick_released)
			{
				...
				if(eof_hover_note >= 0)
				{
					...
					{
						eof_selection.last = eof_hover_note;
						eof_selection.last_pos = eof_song->vocal_track[0]->lyric[eof_selection.last]->pos;
					}
					eof_selection.current = eof_hover_note;
					if(eof_mix_vocal_tones_enabled)
					{
						if(eof_song->vocal_track[0]->lyric[eof_selection.current]->note != EOF_LYRIC_PERCUSSION)
							eof_mix_play_note(eof_song->vocal_track[0]->lyric[eof_selection.current]->note);
						else
							play_sample(eof_sound_chosen_percussion, 255.0 * (eof_percussion_volume / 100.0), 127, 1000 + eof_audio_fine_tune, 0);
					}
					eof_selection.current_pos = eof_song->vocal_track[0]->lyric[eof_selection.current]->pos;
					if(KEY_EITHER_SHIFT)
					{
						if((eof_selection.range_pos_1 == 0) && (eof_selection.range_pos_2 == 0))
						{
					...
					eof_pegged_note = eof_selection.current;
					eof_peg_x = lpos - eof_song->vocal_track[0]->lyric[eof_pegged_note]->pos;
					...
					if(!KEY_EITHER_CTRL)
					{
						...
						if(KEY_EITHER_SHIFT && !ignore_range)
						{
							...
							if(eof_selection.range_pos_1 < eof_selection.range_pos_2)
							{
								for(i = 0; i < eof_song->vocal_track[0]->lyrics; i++)
								{
									if((eof_song->vocal_track[0]->lyric[i]->pos >= eof_selection.range_pos_1) && (eof_song->vocal_track[0]->lyric[i]->pos <= eof_selection.range_pos_2))
									{
							...
							else
							{
								for(i = 0; i < eof_song->vocal_track[0]->lyrics; i++)
								{
									if((eof_song->vocal_track[0]->lyric[i]->pos >= eof_selection.range_pos_2) && (eof_song->vocal_track[0]->lyric[i]->pos <= eof_selection.range_pos_1))
									{
										if(eof_selection.track != EOF_TRACK_VOCALS)
										{
											eof_selection.track = EOF_TRACK_VOCALS;
...
//					eof_mouse_drug = 1;
				...
				if((eof_mouse_drug > 10) && (eof_selection.current != EOF_MAX_NOTES - 1))
				{
					if((eof_snap_mode != EOF_SNAP_OFF) && !KEY_EITHER_CTRL)
					{
						...
						move_offset = (int)drag_snap.pos - (int)eof_song->vocal_track[0]->lyric[eof_pegged_note]->pos;
						eof_last_pen_pos = rpos;
					}
					if(!eof_undo_toggle && ((move_offset != 0) || (eof_snap_mode == EOF_SNAP_OFF) || KEY_EITHER_CTRL))
					{
					...
					for(i = 0; i < eof_song->vocal_track[0]->lyrics; i++)
					{
						if(eof_selection.multi[i])
						{
							if((eof_snap_mode == EOF_SNAP_OFF) || KEY_EITHER_CTRL)
							{
								if(eof_song->vocal_track[0]->lyric[i]->pos == eof_selection.current_pos)
								{
									eof_selection.current_pos += eof_mickeys_x * eof_zoom;
								}
								eof_song->vocal_track[0]->lyric[i]->pos += eof_mickeys_x * eof_zoom;
							}
							else
							{
								if(eof_song->vocal_track[0]->lyric[i]->pos == eof_selection.current_pos)
								...
								eof_song->vocal_track[0]->lyric[i]->pos += move_offset;
							}
							if(eof_song->vocal_track[0]->lyric[i]->pos + eof_song->vocal_track[0]->lyric[i]->length >= eof_music_length)
							{
								revert = 1;
								revert_amount = eof_song->vocal_track[0]->lyric[i]->pos + eof_song->vocal_track[0]->lyric[i]->length - eof_music_length;
							}
						}
					}
					if(revert)
					{
						for(i = 0; i < eof_song->vocal_track[0]->lyrics; i++)
						{
							if(eof_selection.multi[i])
							{
								eof_song->vocal_track[0]->lyric[i]->pos -= revert_amount;
							}
						}
					}
				}
			...
			if((((eof_input_mode != EOF_INPUT_REX) && ((mouse_b & 2) || key[KEY_INSERT])) || (((eof_input_mode == EOF_INPUT_REX) && !KEY_EITHER_SHIFT && !KEY_EITHER_CTRL && (key[KEY_1] || key[KEY_2] || key[KEY_3] || key[KEY_4] || key[KEY_5])) && eof_rclick_released && (eof_pen_lyric.pos < eof_music_length))) || key[KEY_BACKSPACE])
			{
				...
				if(eof_hover_note >= 0)
				{
					...
					{
						eof_vocal_track_delete_lyric(eof_song->vocal_track[0], eof_hover_note);
						eof_selection.current = EOF_MAX_NOTES - 1;
						eof_vocal_track_sort_lyrics(eof_song->vocal_track[0]);
					}

					/* delete only the note */
					else if(eof_pen_lyric.note == eof_song->vocal_track[0]->lyric[eof_hover_note]->note)
					{
						if(!eof_check_string(eof_song->vocal_track[0]->lyric[eof_hover_note]->text))	//If removing the pitch from a note that is already textless
						...
						{
							eof_song->vocal_track[0]->lyric[eof_hover_note]->note = 0;
							eof_selection.current = eof_hover_note;
							eof_selection.track = eof_selected_track;
							memset(eof_selection.multi, 0, sizeof(char) * EOF_MAX_NOTES);
							eof_selection.multi[eof_selection.current] = 1;
					...
					{
						eof_song->vocal_track[0]->lyric[eof_hover_note]->note = eof_pen_lyric.note;
						eof_selection.current = eof_hover_note;
						eof_selection.track = EOF_TRACK_VOCALS;
						memset(eof_selection.multi, 0, sizeof(char) * EOF_MAX_NOTES);
						eof_selection.multi[eof_selection.current] = 1;
			...
			if(eof_snap_mode == EOF_SNAP_OFF)
			{
				if(KEY_EITHER_CTRL)
				{
					for(i = 0; i < eof_song->vocal_track[0]->lyrics; i++)
					{
						if((eof_selection.track == EOF_TRACK_VOCALS) && eof_selection.multi[i])
						{
							eof_song->vocal_track[0]->lyric[i]->length -= eof_mickey_z * 10;
						}
					}
				}
				else
				{
					for(i = 0; i < eof_song->vocal_track[0]->lyrics; i++)
					{
						if((eof_selection.track == EOF_TRACK_VOCALS) && eof_selection.multi[i])
						{
							eof_song->vocal_track[0]->lyric[i]->length -= eof_mickey_z * 100;
						}
					}
				}
			}
...
//				eof_selected_beat = eof_hover_beat;
	...
	else if(eof_song_loaded)
	{
		...
		for(i = 0; i < eof_song->vocal_track[0]->lyrics; i++)
		{
			npos = eof_song->vocal_track[0]->lyric[i]->pos / eof_zoom;
			if((pos - eof_av_delay / eof_zoom > npos) && (pos - eof_av_delay / eof_zoom < npos + (eof_song->vocal_track[0]->lyric[i]->length > 100 ? eof_song->vocal_track[0]->lyric[i]->length : 100) / eof_zoom))
			{
				eof_hover_note = i;
				eof_pen_lyric.note = eof_song->vocal_track[0]->lyric[i]->note;
				break;
			}
		}
		if(i == eof_song->vocal_track[0]->lyrics)
		{
			eof_hover_note = -1;
			eof_pen_lyric.note = 0;
		}
...
void eof_render_editor_window(void)
{
	...
	{	//Render all visible notes in the list
		if((eof_note_type == eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->type) && (eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->pos + eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i]->length >= start))
		{	//If this note is in the selected instrument difficulty and would render at or after the left edge of the piano roll
			if(((eof_input_mode == EOF_INPUT_PIANO_ROLL) || (eof_input_mode == EOF_INPUT_REX)) && eof_music_paused)
			{
				if(eof_hover_note == i)
				{
					eof_note_draw(eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i], ((eof_selection.track == eof_selected_track) && eof_selection.multi[i] && eof_music_paused) ? 1 : i == eof_hover_note ? 2 : 3);
				}
				else
				{
					if(eof_note_draw(eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->note[i], ((eof_selection.track == eof_selected_track) && eof_selection.multi[i] && eof_music_paused) ? 1 : i == eof_hover_note ? 2 : 0) == 1)
...
void eof_render_vocal_editor_window(void)
{
	...
	{ 	//The -5 is a vertical offset to allow the phrase marker rectangle render as high as the lyric text itself.  The +4 is an offset to allow the rectangle to render as low as the lyric text
		rectfill(eof_window_editor->screen, lpos + eof_song->vocal_track[0]->line[i].start_pos / eof_zoom, EOF_EDITOR_RENDER_OFFSET + (15-5) + eof_screen_layout.note_y[0] - 2 + 8, lpos + eof_song->vocal_track[0]->line[i].end_pos / eof_zoom, EOF_EDITOR_RENDER_OFFSET + 15 + eof_screen_layout.note_y[0] + 2 + 8 +4, (eof_song->vocal_track[0]->line[i].flags & EOF_LYRIC_LINE_FLAG_OVERDRIVE) ? makecol(64, 128, 64) : makecol(0, 0, 127));
	}

	start = eof_determine_piano_roll_left_edge();
	for(i = 0; i < eof_song->vocal_track[0]->lyrics; i++)
	{
		if(eof_song->vocal_track[0]->lyric[i]->pos + eof_song->vocal_track[0]->lyric[i]->length >= start)
	...
	if(eof_hover_note >= 0)
	{
		eof_lyric_draw(eof_song->vocal_track[0]->lyric[eof_hover_note], 2);
	}
	if(eof_music_paused && eof_pen_visible && (eof_pen_note.pos < eof_music_length))
	{
		if(!eof_mouse_drug)
...
void eof_render_editor_window_common(void)
{
	...
	if(eof_selected_track != EOF_TRACK_VOCALS)
	{
		...
		/* draw solo sections */
		for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->solos; i++)
		{
			if(eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->solo[i].end_pos >= start)	//If the solo section would render at or after the left edge of the piano roll
				rectfill(eof_window_editor->screen, lpos + eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->solo[i].start_pos / eof_zoom, EOF_EDITOR_RENDER_OFFSET + 25, lpos + eof_song->legacy_track[eof_song->track[eof_selected_track-1]->tracknum]->solo[i].end_pos / eof_zoom, EOF_EDITOR_RENDER_OFFSET + eof_screen_layout.fretboard_h - 1, col);
		}
	}
