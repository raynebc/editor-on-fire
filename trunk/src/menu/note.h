...
int eof_rocksmith_convert_string_mute_to_palm_mute(void);	//Removes string mute status from all selected notes and marks affected notes with palm mute status
