	...
	if(eof_song && eof_song_loaded)
	{
		...
		{	//PART VOCALS NOT SELECTED
			for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->notes; i++)
			{
				...
				{
					if(eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->pos < sel_start)
					{
						sel_start = eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->pos;
					}
					if(eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->pos > sel_end)
					{
						sel_end = eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->pos + eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->length;
					}
				}
				if((eof_selection.track == eof_selected_track) && eof_selection.multi[i] && (eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->type == eof_note_type))
				{
					selected++;
					if(eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->note)
					{
						vselected++;
					}
				}
			...
			{
				if((sel_end >= eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->star_power_path[j].start_pos) && (sel_start <= eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->star_power_path[j].end_pos))
				{
					insp = 1;
					spstart = sel_start;
					spend = sel_end;
			...
			{
				if((sel_end >= eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->solo[j].start_pos) && (sel_start <= eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->solo[j].end_pos))
				{
					insolo = 1;
					ssstart = sel_start;
					ssend = sel_end;
...
int eof_menu_note_transpose_up(void)
{
	...
	else
	{
		...
		for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->notes; i++)
		{
			if((eof_selection.track == eof_selected_track) && eof_selection.multi[i] && (eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->type == eof_note_type))
			{
				eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->note = (eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->note << 1) & 31;
			}
		}
	}
	return 1;
...
int eof_menu_note_resnap(void)
{
	...
	int i;
	int oldnotes = eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->notes;
	...
	for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->notes; i++)
	{
		if((eof_selection.track == eof_selected_track) && eof_selection.multi[i] && (eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->type == eof_note_type))
		{
			...
			/* snap the note itself */
			eof_snap_logic(&eof_tail_snap, eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->pos);
			eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->pos = eof_tail_snap.pos;
	...
	if(oldnotes != eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->notes)
	{
...
int eof_menu_note_delete(void)
{
	...
	if(d)
	{
		...
		{
			if((eof_selection.track == eof_selected_track) && eof_selection.multi[i] && (eof_selection.track == eof_selected_track && eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->type == eof_note_type))
			{
				eof_track_delete_note(eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum], i);
				eof_selection.multi[i] = 0;
			}
		}
		eof_selection.current = EOF_MAX_NOTES - 1;
...
int eof_menu_note_toggle_green(void)
{
	...
	for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->notes; i++)
	{
		if((eof_selection.track == eof_selected_track) && eof_selection.multi[i] && (eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->type == eof_note_type))
		{
			eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->note ^= 1;
			if(eof_selected_track == EOF_TRACK_DRUM)
...
int eof_menu_note_toggle_red(void)
{
	...
	for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->notes; i++)
	{
		if((eof_selection.track == eof_selected_track) && eof_selection.multi[i] && (eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->type == eof_note_type))
		{
			eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->note ^= 2;
		}
	}
	return 1;
}
...
int eof_menu_note_toggle_yellow(void)
{
	...
	for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->notes; i++)
	{
		if((eof_selection.track == eof_selected_track) && eof_selection.multi[i] && (eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->type == eof_note_type))
		{
			eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->note ^= 4;
			if(eof_selected_track == EOF_TRACK_DRUM)
			{	//If yellow drum is being toggled on/off
				eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->flags &= (~EOF_NOTE_FLAG_Y_CYMBAL);	//Clear the Pro yellow cymbal status if it is set
				if(eof_mark_drums_as_cymbal && (eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->note & 4))
				{	//If user specified to mark new notes as cymbals, and this note was toggled on
					eof_set_flags_at_note_pos(eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum],i,EOF_NOTE_FLAG_Y_CYMBAL,1);	//Set the yellow cymbal flag on all drum notes at this position
				}
			}
		}
	}
...
int eof_menu_note_toggle_blue(void)
{
	...
	for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->notes; i++)
	{
		if((eof_selection.track == eof_selected_track) && eof_selection.multi[i] && (eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->type == eof_note_type))
		{
			eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->note ^= 8;
			if(eof_selected_track == EOF_TRACK_DRUM)
			{	//If blue drum is being toggled on/off
				eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->flags &= (~EOF_NOTE_FLAG_B_CYMBAL);	//Clear the Pro blue cymbal status if it is set
				if(eof_mark_drums_as_cymbal && (eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->note & 8))
				{	//If user specified to mark new notes as cymbals, and this note was toggled on
					eof_set_flags_at_note_pos(eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum],i,EOF_NOTE_FLAG_B_CYMBAL,1);	//Set the blue cymbal flag on all drum notes at this position
				}
			}
		}
	}
...
int eof_menu_note_toggle_purple(void)
{
	...
	for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->notes; i++)
	{
		if((eof_selection.track == eof_selected_track) && eof_selection.multi[i] && (eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->type == eof_note_type))
		{
			eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->note ^= 16;
			if(eof_selected_track == EOF_TRACK_DRUM)
			{	//If green drum is being toggled on/off
				eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->flags &= (~EOF_NOTE_FLAG_G_CYMBAL);	//Clear the Pro green cymbal status if it is set
				if(eof_mark_drums_as_cymbal && (eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->note & 16))
				{	//If user specified to mark new notes as cymbals, and this note was toggled on
					eof_set_flags_at_note_pos(eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum],i,EOF_NOTE_FLAG_G_CYMBAL,1);	//Set the green cymbal flag on all drum notes at this position
				}
			}
		}
	}
...
int eof_menu_note_toggle_crazy(void)
{
	...
	for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->notes; i++)
	{
		if((eof_selection.track == eof_selected_track) && eof_selection.multi[i] && (eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->type == eof_note_type))
		{
			...
			eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->flags ^= EOF_NOTE_FLAG_CRAZY;
		}
	}
	return 1;
}
...
int eof_menu_note_toggle_double_bass(void)
{
	...
	for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->notes; i++)
	{
		if((eof_selection.track == eof_selected_track) && eof_selection.multi[i] && (eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->type == EOF_NOTE_AMAZING) && (eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->note & 1))
		{	//If this note is in the currently active track, is selected, is in the Expert difficulty and has a green gem
			...
			eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->flags ^= EOF_NOTE_FLAG_DBASS;
		}
	}
	return 1;
}
...
int eof_menu_note_toggle_rb3_cymbal_green(void)
{
	...
	for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->notes; i++)
	{
		...
		{	//If this note is in the currently active track and is selected
			if(eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->note & 16)
...
int eof_menu_note_toggle_rb3_cymbal_yellow(void)
{
	...
	for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->notes; i++)
	{
		if((eof_selection.track == eof_selected_track) && eof_selection.multi[i])
		{	//If this note is in the currently active track and is selected
			if(eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->note & 4)
...
int eof_menu_note_toggle_rb3_cymbal_blue(void)
{
	...
	for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->notes; i++)
	{
		if((eof_selection.track == eof_selected_track) && eof_selection.multi[i])
		{	//If this note is in the currently active track and is selected
			if(eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->note & 8)
...
//				eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->flags ^= EOF_NOTE_FLAG_B_CYMBAL;
				eof_set_flags_at_note_pos(eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum],i,EOF_NOTE_FLAG_B_CYMBAL,2);	//Toggle the blue cymbal flag on all drum notes at this position
			}
		}
	}
	return 1;
...
int eof_menu_note_remove_cymbal(void)
{
	...
	for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->notes; i++)
	{
		if((eof_selection.track == eof_selected_track) && eof_selection.multi[i])
		{	//If this note is in the currently active track and is selected
			if(	((eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->note & 4) && (eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->flags & EOF_NOTE_FLAG_Y_CYMBAL)) ||
				((eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->note & 8) && (eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->flags & EOF_NOTE_FLAG_B_CYMBAL)) ||
				((eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->note & 16) && (eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->flags & EOF_NOTE_FLAG_G_CYMBAL)))
			{	//If this note has a cymbal notation
				...
				eof_set_flags_at_note_pos(eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum],i,EOF_NOTE_FLAG_Y_CYMBAL,0);	//Clear the yellow cymbal flag on all drum notes at this position
				eof_set_flags_at_note_pos(eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum],i,EOF_NOTE_FLAG_B_CYMBAL,0);	//Clear the blue cymbal flag on all drum notes at this position
				eof_set_flags_at_note_pos(eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum],i,EOF_NOTE_FLAG_G_CYMBAL,0);	//Clear the green cymbal flag on all drum notes at this position
			}
		}
	}
	return 1;
...
int eof_menu_note_push_back(void)
{
	...
	if(eof_count_selected_notes(NULL, 0) > 0)
	{
		for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->notes; i++)
		{
			...
			{
				beat = eof_get_beat(eof_song, eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->pos);
				porpos = eof_get_porpos(eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->pos);
				eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->pos = eof_put_porpos(beat, porpos, eof_menu_note_push_get_offset());
			}
		}
	}
	else
	{
		for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->notes; i++)
		{
			if(eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->pos >= eof_music_pos - eof_av_delay)
			{
				beat = eof_get_beat(eof_song, eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->pos);
				porpos = eof_get_porpos(eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->pos);
				eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->pos = eof_put_porpos(beat, porpos, eof_menu_note_push_get_offset());
...
int eof_menu_note_create_bre(void)
{
	...
	for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->notes; i++)
	{
		if((eof_selection.track == eof_selected_track) && eof_selection.multi[i] && (eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->type == eof_note_type))
		{
			if(eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->pos > first_pos)
			{
				first_pos = eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->pos;
			}
			if(eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->pos < last_pos)
			{
				last_pos = eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->pos;
			}
		}
	}
...
int eof_menu_solo_mark(void)
{
	...
	for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->notes; i++)
	{
		if((eof_selection.track == eof_selected_track) && eof_selection.multi[i] && (eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->type == eof_note_type))
		{
			...
			if(eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->pos + eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->length > sel_end)
			{
				sel_end = eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->pos + eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->length;
			}
		}
	...
	if(insp < 0)
	{
		eof_track_add_solo(eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum], sel_start, sel_end);
	}
	else
	{
		eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->solo[insp].start_pos = sel_start;
		eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->solo[insp].end_pos = sel_end;
	}
	return 1;
}
...
int eof_menu_solo_unmark(void)
{
	...
	for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->notes; i++)
	{
		if((eof_selection.track == eof_selected_track) && eof_selection.multi[i] && (eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->type == eof_note_type))
		{
			for(j = 0; j < eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->solos; j++)
			{
				if((eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->pos >= eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->solo[j].start_pos) && (eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->pos + eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->length <= eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->solo[j].end_pos))
				{
...
int eof_menu_solo_erase_all(void)
{
	...
	{
		eof_prepare_undo(EOF_UNDO_TYPE_NONE);
		eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->solos = 0;
	}
	return 1;
}
...
int eof_menu_star_power_mark(void)
{
	...
	for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->notes; i++)
	{
		if((eof_selection.track == eof_selected_track) && eof_selection.multi[i] && (eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->type == eof_note_type))
		{
			...
			if(eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->pos > sel_end)
			{
				sel_end = eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->pos + (eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->length > 20 ? eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->length : 20);
			}
		}
	}
	for(j = 0; j < eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->star_power_paths; j++)
	...
	if(insp < 0)
	{
		eof_track_add_star_power(eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum], sel_start, sel_end);
	}
	else
	{
		eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->star_power_path[insp].start_pos = sel_start;
		eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->star_power_path[insp].end_pos = sel_end;
	}
	eof_determine_hopos();
	return 1;
}
...
int eof_menu_star_power_erase_all(void)
{
	...
	{
		eof_prepare_undo(EOF_UNDO_TYPE_NONE);
		eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->star_power_paths = 0;
	}
	eof_determine_hopos();
	return 1;
}
...
int eof_menu_hopo_auto(void)
{
	...
	for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->notes; i++)
	{
		if(eof_selection.multi[i])
		{
			if(eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->flags & EOF_NOTE_FLAG_F_HOPO)
			{
				eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->flags ^= EOF_NOTE_FLAG_F_HOPO;
			}
			if(eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->flags & EOF_NOTE_FLAG_NO_HOPO)
			{
				eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->flags ^= EOF_NOTE_FLAG_NO_HOPO;
			}
		}
	}
	eof_determine_hopos();
		...
		for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->notes; i++)
		{
			if(eof_selection.multi[i])
			{
				...
				{	//If the note was a forced on HOPO, make it a forced off HOPO
					eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->flags &= !EOF_NOTE_FLAG_F_HOPO;	//Turn off forced on hopo
					eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->flags |= EOF_NOTE_FLAG_NO_HOPO;	//Turn on forced off hopo
				}
				else if(eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->flags & EOF_NOTE_FLAG_NO_HOPO)
				{	//If the note was a forced off HOPO, make it an auto HOPO
					eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->flags &= !EOF_NOTE_FLAG_F_HOPO;
					eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->flags &= !EOF_NOTE_FLAG_NO_HOPO;	//Turn off forced off hopo
				}
				else
				{	//If the note was an auto HOPO, make it a forced on HOPO
					eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->flags |= EOF_NOTE_FLAG_F_HOPO;	//Turn on forced on hopo
				}
			}
		}
		eof_determine_hopos();
...
int eof_transpose_possible(int dir)
{
	...
	{
		if(eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->notes <= 0)
		{
			return 0;
		}
		...
		for(i = 0; i < eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->notes; i++)
		{
			if((eof_selection.track == eof_selected_track) && eof_selection.multi[i] && (eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->type == eof_note_type))
			{
				if((eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->note & 1) && (dir > 0))
				{
					return 0;
				}
				else if((eof_song->legacy_track[eof_song->track[eof_selected_track]->tracknum]->note[i]->note & 16) && (dir < 0))
				{
					return 0;
				}
			}
