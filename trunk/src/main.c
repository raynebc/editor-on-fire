...
int         eof_note_type_i = EOF_NOTE_AMAZING;		//The active difficulty for instrumental tracks
int         eof_note_type_v = EOF_NOTE_SUPAEASY;	//The active difficulty for the vocal track
