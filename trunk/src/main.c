...
char        eof_last_midi_path[1024] = {0};
char        eof_last_db_path[1024] = {0};
char        eof_last_gh_path[1024] = {0};
char        eof_last_lyric_path[1024] = {0};
char        eof_last_gp_path[1024] = {0};
char        eof_last_rs_path[1024] = {0};
