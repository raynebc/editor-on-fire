...
int         eof_gp_import_preference_1 = 0;		//If nonzero, GP import automatically imports text events without prompting.  Beat texts with qualifying strings are imported as RS sections, section markers as RS phrases.
